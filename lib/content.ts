...
אשמח לקבלת המשך פרטים לביצוע ההזמנה.`,
    ...
    about: {
      ...
      paras: [
        "שמי שושנה דרור.",
        "במשך שנים רבות אני עוסקת בתכנון ועיצוב מוצרי יודאיקה לייצור תעשייתי, בעבודה עם יבואנים ויצרנים. עד היום פעלתי בעיקר מאחורי הקלעים — המוצרים שעיצבתי יוצרו ושווקו תחת המותגים של לקוחותיי.",
        ...
        "סדרת דיוקנאות קרליבך היא צעד חדש עבורי — סדרת היצירות הראשונה שאני מביאה ישירות אל הקהל תחת שמי. היא גם הראשונה בפרויקט דיוקנאות המתכת, המתוכנן להתרחב בעתיד לדמויות נוספות.",
      ],
...
Please send me the next steps to complete the order.`,
    ...
    about: {
      ...
      paras: [
        ...
        "For many years, I have been designing Judaica products for industrial production, working with manufacturers and importers. Until now, I have worked primarily behind the scenes — the products I designed were produced and marketed under my clients’ brands.",
        "I believe that a Jewish object is more than a functional item or a decorative piece. It can carry meaning, memory, and values.",
        "In every creation, I strive to combine technical precision, artistic expression, and respect for the meaning it represents.",
        "The Carlebach Portrait Series marks a new chapter for me — the first collection I am bringing directly to the public under my own name. It is also the first in an ongoing metal portrait project, with additional figures planned for the future.",
      ],
